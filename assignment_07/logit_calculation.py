...
os.chdir('C:\\Users\\robyn\\OneDrive\\Documents\\QMB6358\\My assignments2\\QMB6358_Solutions\\assignment_07')
...
# Complete this command:
soln_nm = minimize(logit_likelihood, beta_0, (y,X), method='Nelder-Mead',
...
# Complete this command:
soln_dfp = minimize(logit_likelihood, beta_0, (y,X), method='powell',
...
# Complete this command:
soln_bfgs = minimize(logit_likelihood, beta_0, (y,X), method='BFGS',
                    options = {'disp': True})
...
# Complete this command:
soln_bfgs_jac = minimize(logit_likelihood, beta_0, (y,X),jac=logit_gradient, method='BFGS',
                        options={'disp': True})
